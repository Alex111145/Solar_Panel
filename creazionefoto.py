...
# ==============================================================================
# 1. GENERAZIONE SCHEMA TILING (Pannello Inclinato Correttamente)
# ==============================================================================
def genera_schema_tiling():
    ...
    # 🔥 MODIFICA: Poligono ruotato "dall'altra parte" (Antiorario)
    polygon_points = [[350, 220], [450, 200], [470, 400], [370, 420]]
    ...
    plt.close()
    print(f"✅ Salvato con successo (Inclinazione corretta): {OUTPUT_TILING}")
